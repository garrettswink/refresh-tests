  ...
  return (
    <main className="pt-20">
      ...
      <Overview
        ...
        body={[
          "I've built my career inside communications agencies in New York and Washington, D.C., leading integrated programs across B2B, B2C, and public affairs. My work spans paid, earned, and social media, with messaging aligned across channels and grounded in measurable results.",
